...
public class BorrowingController extends AbstractCrudController<BorrowingService, Borrowing, BorrowingDto, BorrowingRepository, BorrowingMapper> {
    ...
    public ResponseEntity<BorrowingDto> findByCode(@PathVariable String code) {
        Optional<BorrowingDto> key = service.findByCode(code);
