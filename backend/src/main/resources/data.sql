...
VALUES
    ...
    ('IK-104', 'Gépterem', '0', 'IK', 17, 30, 'LABORATORY');

INSERT INTO key (room_id, code, status)
VALUES
    (1, 'AB10000', 'AVAILABLE'),
    (2, 'AB10001', 'AVAILABLE'),
    (3, 'AB10002', 'CHECKED_OUT');

INSERT INTO applicant (first_name, last_name, personal_id_number, email_address, phone_number, type)
VALUES
    ('István', 'Nagy', '123456AB', 'nagy.istvan@email.hu', '+36301231234', 'STUDENT'),
    ('Ilona', 'Takarító', '654321AB', 'takarito.ilona@email.hu', '+36203214321', 'EMPLOYEE'),
    ('Béla', 'Külsős', '123321AB', 'kulcsos.bela@email.hu', '+36703211234', 'EMPLOYEE');
...
INSERT INTO assignment (key_id, user_id, applicant_id, start_time, end_time, date)
VALUES
