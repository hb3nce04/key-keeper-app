...
VALUES
    ('admin', '$2a$10$YibFlVtQxcgZyHxCkB3VI.RDgDdgEnrt0WEOf3aIfznVe7fGK2rRq', 'admin@email.hu', 'ADMIN'),
    ('user', '$2a$10$xg13urHcaGWSUAMgo8MRSeuFIAncKZYkshaJCt4Il2evk63oIform', 'user@email.hu', 'USER');
